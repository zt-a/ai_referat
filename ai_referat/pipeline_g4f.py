...
from ai_referat.models import (
    Essay, Chapter, Subchapter, Introduction, Conclusion, References, EssayMetadata
)
...
from ai_referat.client_g4f import AIClientSync, AIClientAsync  # твой новый g4f клиент
